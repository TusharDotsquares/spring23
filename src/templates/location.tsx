...
console.log(JSON.stringify(c_richDescription),"JSON.stringify(c_richDescription)")
  return (
    <>
      <PageLayout>
        ...
        <div className="centered-container">
          ...
          <div className="grid gap-x-10 gap-y-10 md:grid-cols-2">
            <Details files={c_files} />
            {hours && <Hours title={"Restaurant Hours"} hours={hours} />}
            {description && <About name={name} description={description} />}
          </div>
        </div>
        <LexicalRichText serializedAST={JSON.stringify(c_richDescription.json)} nodeClassNames={nodeClassNames} />
      </PageLayout>
